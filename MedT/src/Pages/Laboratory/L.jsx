                ...
                <td style={{width: "15%"}}>
                  ...
                  >
                    ...
                    <button 
                            ...
                            onClick={() => setVisible(false)}><IoMdClose /></button>
                      <tr>
                        <td style={{color: "#7161ef", fontWeight: "bold"}}>ItemName:</td>
                        <td style={{color: "#360568", padding: ".5rem"}}>{labitem.itemName}</td>
                      </tr>
                      <tr>
                        <td style={{color: "#7161ef", fontWeight: "bold"}}>LabType:</td>
                        <td style={{color: "#360568", padding: ".5rem"}}>{labitem.labType}</td>
                      </tr>
                      <tr>
                        <td style={{color: "#7161ef", fontWeight: "bold"}}>MainCategory:</td>
                        <td style={{color: "#360568", padding: ".5rem"}}>{labitem.mainCategory}</td>
                      </tr>
                      <tr style={{color: "#360568", margin: ".5rem"}}>
                        <td style={{color: "#7161ef", fontWeight: "bold"}}>SubCategory:</td>
                        <td style={{color: "#360568", padding: ".5rem"}}>{labitem.subCategory}</td>
                      </tr>
                      <tr>
                        <td style={{color: "#7161ef", fontWeight: "bold"}}>ItemCode:</td>
                        <td style={{color: "#360568", padding: "1rem"}}>{labitem.itemCode}</td>
                      </tr>
                      <tr>
                        <td style={{color: "#7161ef", fontWeight: "bold"}}>Price:</td>
                        <td style={{color: "#360568", padding: "1rem"}}>{labitem.price}</td>
                      </tr>
                    </div> 
                    <button className="backBtn" onClick={() => setVisible(false)}>Go Back</button>
                  </Model>
                  <button 
                  style={{cursor: "pointer"}}
                  className="update" onClick={() => openModall()}>update</button>
                  <Model
                  isOpen={updateModal}
                ...
                >
                  <div className="modalTablel">
                        <Toaster />
                            ...
                            onClick={() => setUpdateModal(false)}><IoMdClose /></button>
                                <tr>
                                    <td>
                    ...
                    <br />{" "}
                    <br />
                    <button onClick={() => setUpdateModal(false)} className="backBtn" >Go Back</button>
                    <button className="upModalBtn"
                      onClick={() => {
                  ...
                  <button 
                  style={{cursor: "pointer"}}
                  className="delete" onClick={() => setPop(true)}>delete</button>
                  <Model  isOpen={pop}
                    onRequestClose={() => setPop(false)}  style={{
                      ...
                      <button className="labModalBtn_no" style={{margin: ".5rem", padding: ".5rem .9rem", cursor: "pointer"}} onClick={() => setPop(false)}>No</button>
                      <button className="labModalBtn_yes" style={{margin: ".5rem", padding: ".5rem .9rem", cursor: "pointer"}} onClick={() =>
                    {
                     del(labitem._id);
